...
<body>
	<form action=${pageContext.request.contextPath}/Room method="post"> <!-- Activate the Room Overview -->
		<input class="Activation" type="submit" value="Show Rooms" />
	</form>
	<form action=${pageContext.request.contextPath}/Room method="get"> <!-- Room.java processes the input in doGet() method -->
	<table id="roomTable"> 
		<tr>
